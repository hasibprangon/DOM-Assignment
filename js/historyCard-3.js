...
document.getElementById('ThirdBtnDonate').addEventListener('click', function () {
    const donationHistory = document.getElementById('historySection');
    const getMainBalance = getTextValueById('mainBalance')
    const getInputValue = getInputValueById('thirdInput');
    const getHeading = document.getElementById('quotaMovement').innerText;
    const time = new Date();
